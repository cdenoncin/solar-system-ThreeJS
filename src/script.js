...
const toggleOrbitLinesButton = document.getElementById('toggleOrbitLinesButton');
...
function handleClick(event) {
    ...
    if (intersects.length > 0) {
        ...
        const zoomAnimationDuration = 1000;
        const currentCameraPosition = camera.position.clone();
        const targetZoomPosition = intersectedPlanet.position.clone().multiplyScalar(zoomMultiplier);
